...
Health Check
    ...
    TRY
        ${maintenance_button_exists}=    SikuliLibrary.Exists    but_purple_maintenance_continue    ${timeoutsec}
    ...
    # Primary Test :A1 - Wait Until Screen Contains Veradigm Practice mgmt
     TRY
        ${veradigm_pm_tenent_button_exists}=    SikuliLibrary.Exists    drp_dwn_btn_pm_login    ${timeoutsec}
        IF    ${veradigm_pm_tenent_button_exists} == True
    ...
    #Primary Test :1 - Wait Until Screen Contains The First Allscripts PM Screen And Search For Test Patient
    SikuliLibrary.Wait Until Screen Contain    allscripts_pm_first_screen.png    ${timeoutsec}
    BuiltIn.Sleep    5s
    SikuliLibrary.click    allscripts_pm_pt_reg.png    xOffset=0    yOffset=-5
    SikuliLibrary.click    allscripts_pm_open_reg.png
    SikuliLibrary.Wait Until Screen Contain    allscripts_pm_reg_tab.png    ${timeoutsec}
    ...
    SikuliLibrary.Wait Until Screen Contain    allscripts_pm_schd_reg_tab.png    ${timeoutsec}
